...
- **Application to data with missing values**: *Learning disease progression models with longitudinal data and missing values*. R. Couronne, M. Vidailhet, JC. Corvol, S. Lehéricy, S. Durrleman. ISBI, April 2019. `Open Access <https://hal.archives-ouvertes.fr/hal-02091571v2/document>`_
