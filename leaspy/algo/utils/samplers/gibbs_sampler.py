    ...
    **base_sampler_kws
    ...
    def _sample_population_realizations(
        ...
        **attachment_computation_kws
        ...
        """
        realization = realizations.get_by_name(self.name)
        ...
        ind_params = realizations.individual_tensors_dict
        ...
        **attachment_computation_kws
        ...
        def compute_attachment_regularity():
            ...
            attachment = model.compute_individual_attachment_tensorized(
                data, realizations.individual_tensors_dict, attribute_type=attribute_type
            )
        ...
        realization.tensor_realizations = (
            accepted * realization.tensor_realizations
