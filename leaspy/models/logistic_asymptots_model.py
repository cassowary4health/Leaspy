...
class LogisticAsymptotsModel(AbstractMultivariateModel):
    """
    ...
    def compute_individual_tensorized(self, timepoints, ind_parameters, attribute_type=None):
        ...
        g, v0, asymptots, a_matrix = self._get_attributes(attribute_type)

        # Individual parameters
        xi, tau = ind_parameters['xi'], ind_parameters['tau']
        asymptots[asymptots != asymptots] = self.max_asymptot
    ...
    def initialize_MCMC_toolbox(self):
        self.MCMC_toolbox = {
            'priors': {'g_std': 0.01, 'v0_std': 0.01, 'asymptots_std': 0.01, 'betas_std': 0.01},
