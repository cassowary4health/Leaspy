...
@doc_with_super()
class UnivariateV0Model(AbstractModel, OrdinalModelMixin):
    """
    ...
    **kwargs
    ...
    SUBTYPES_SUFFIXES = {
        'univariatev0_linear': '_linear',
        'univariatev0_logistic': '_logistic'
    }
...
doc_with_(UnivariateV0Model.compute_individual_tensorized_linear,
          UnivariateV0Model.compute_individual_tensorized,
          mapping={'the model': 'the model (linear)'})
doc_with_(UnivariateV0Model.compute_individual_tensorized_logistic,
          UnivariateV0Model.compute_individual_tensorized,
          mapping={'the model': 'the model (logistic)'})

doc_with_(UnivariateV0Model.compute_jacobian_tensorized_linear,
          UnivariateV0Model.compute_jacobian_tensorized,
          mapping={'the model': 'the model (linear)'})
doc_with_(UnivariateV0Model.compute_jacobian_tensorized_logistic,
          UnivariateV0Model.compute_jacobian_tensorized,
          mapping={'the model': 'the model (logistic)'})

doc_with_(UnivariateV0Model.compute_individual_ages_from_biomarker_values_tensorized_logistic,
          UnivariateV0Model.compute_individual_ages_from_biomarker_values_tensorized,
          mapping={'the model': 'the model (logistic)'})
