...
@doc_with_super()
class VelocityMultivariateModel(AbstractMultivariateModel):
    """
    ...
    **kwargs
    ...
    SUBTYPES_SUFFIXES = {
        'velocity_linear': '_linear',
        'velocity_logistic': '_logistic',
    }

    def __init__(self, name: str, **kwargs):
        super().__init__(name, **kwargs)
        self.parameters["v0"] = None
        self.parameters["vi_mean"] = None
        self.parameters["vi_std"] = None
    ...
    def _check_subtype(self):
        if self.name not in self.SUBTYPES_SUFFIXES.keys():
            raise LeaspyModelInputError(f'Velocity multivariate model name should be among these valid sub-types: '
