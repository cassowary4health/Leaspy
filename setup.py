...
setup(name="leaspy",
      ...
      packages=['leaspy',
                ...
                'leaspy.leaspy_io',
                'leaspy.leaspy_io.data',
                'leaspy.leaspy_io.settings',
                'leaspy.leaspy_io.realizations',
                'leaspy.leaspy_io.outputs',
                'leaspy.leaspy_io.logs',
                'leaspy.leaspy_io.logs.visualization',
