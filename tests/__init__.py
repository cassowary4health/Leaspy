...
default_data_dir = os.path.join(os.path.dirname(__file__), "../leaspy/models/data")

example_data_path = os.path.join(os.path.dirname(__file__), "_data/inputs/data_tiny.csv")
