...
from .models.model_factory import ModelFactoryTest
...
class LeaspyTest(unittest.TestCase):
    ...
    # REPRENDRE LE TRAVAIL DE RAPHAEL SUR test/__init__.py et _data/ POUR
    # GENERER, STOCKER ET APPELER CORECTEMENT 'torch_data_path.pt' et
    # 'json_data_path.json'
