...
class DatasetTest(unittest.TestCase):
    ...
    def test_constructor_univariate(self):
        path_to_data = os.path.join(test_data_dir, 'leaspy_io', "data", 'univariate_data_for_dataset.csv')
    ...
    def test_constructor_multivariate(self):
        path_to_data = os.path.join(test_data_dir, 'leaspy_io', "data", 'multivariate_data_for_dataset.csv')
        data = Data.from_csv_file(path_to_data)
        dataset = Dataset(data)
