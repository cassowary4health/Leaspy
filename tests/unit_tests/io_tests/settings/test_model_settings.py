...
class ModelSettingsTest(unittest.TestCase):
    ...
    def test_model_settings_univariate(self):
        path_to_model_settings = os.path.join(test_data_dir, 'leaspy_io', 'settings', 'model_settings_univariate.json')
    ...
    def test_model_settings_multivariate(self):
        path_to_model_settings = os.path.join(test_data_dir, 'leaspy_io', 'settings', 'model_settings_multivariate.json')
        model_settings = ModelSettings(path_to_model_settings)
